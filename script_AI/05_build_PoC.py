...
BASE_PROLOGUE = (
    "Please generate Proof-of-Concept code for the following source code in "
    "proving vulnerabilities, unsafe patterns, or best‑practice violations it may contain."
)
